...
public interface PeriodicStaticsDao {
	...
	public abstract PeriodicStatics selectPeriodicStaticsByPeriodAndUserId(@Param("userId") long userId, @Param("periodStart") Timestamp periodStart, @Param("periodEnd") Timestamp periodEnd);
